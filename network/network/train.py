...
model = keras.Sequential([
    ...
    keras.layers.Conv2D(kernel_size=3, filters=8, strides=1, padding='same', activation='relu'),
    ...
    keras.layers.MaxPool2D(pool_size=(2, 2)),
    keras.layers.Conv2D(kernel_size=3, filters=129, strides=1, padding='same', activation='relu'),
